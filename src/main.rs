...
use glium::{self, uniform, DrawParameters, Program, Surface, glutin::event::VirtualKeyCode};
...
fn main() {
    ...
    let ambient_light: [f32; 3] = [0.0, 0.0, 0.0];
...
_ => {}
        ...
        glium::glutin::event::Event::WindowEvent {
            ...
            ..
        } => camera.set_aspect_ratio(new_window_size.width as f32 / new_window_size.height as f32),
